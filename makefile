...
KERN_SRC = $(KERN_DIR)/crt0.s $(KERN_DIR)/boot.s $(KERN_DIR)/trampoline.s $(KERN_DIR)/main.c $(KERN_DIR)/io.c $(KERN_DIR)/string.c $(KERN_DIR)/proc.c $(KERN_DIR)/trap.c $(KERN_DIR)/kalloc.c $(KERN_DIR)/timer.c
