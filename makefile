...
KERN_SRC = $(KERN_DIR)/crt0.s $(KERN_DIR)/boot.s $(KERN_DIR)/trampoline.s $(KERN_DIR)/main.c $(KERN_DIR)/printk.c $(KERN_DIR)/string.c $(KERN_DIR)/proc.c $(KERN_DIR)/trap.c $(KERN_DIR)/kalloc.c $(KERN_DIR)/timer.c $(KERN_DIR)/syscall.c $(KERN_DIR)/initcode.s $(KERN_DIR)/debugger.c $(KERN_DIR)/uart.c
