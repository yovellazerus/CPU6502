...
/*
    ...
    CPU_tick(cpu, 3);
*/
void instruction_BIT_Absolute(CPU_t* cpu) { UNUSED(); }
/*
...
// Arithmetic
void instruction_ADC_Immediate(CPU_t* cpu) { UNUSED(); }
/*
...
*/
void instruction_ADC_ZeroPage(CPU_t* cpu) { UNUSED(); }
/*
    ...
    CPU_tick(cpu, 3);
*/
void instruction_ADC_ZeroPageX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ADC_Absolute(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ADC_AbsoluteX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ADC_AbsoluteY(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ADC_IndirectX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ADC_IndirectY(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/

void instruction_SBC_Immediate(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_SBC_ZeroPage(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_SBC_ZeroPageX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_SBC_Absolute(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_SBC_AbsoluteX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_SBC_AbsoluteY(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_SBC_IndirectX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_SBC_IndirectY(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();
...
void instruction_CMP_Immediate(CPU_t* cpu) { UNUSED(); }
    
void instruction_CMP_ZeroPage(CPU_t* cpu) { UNUSED(); }

void instruction_CMP_ZeroPageX(CPU_t* cpu) { UNUSED(); }/*
    UNUSED();

*/
void instruction_CMP_Absolute(CPU_t* cpu) { UNUSED(); }/*
    UNUSED();

*/
void instruction_CMP_AbsoluteX(CPU_t* cpu) { UNUSED(); }/*
    UNUSED();

*/
void instruction_CMP_AbsoluteY(CPU_t* cpu) { UNUSED(); }/*
    UNUSED();

*/
void instruction_CMP_IndirectX(CPU_t* cpu) { UNUSED(); }/*
    UNUSED();

*/
void instruction_CMP_IndirectY(CPU_t* cpu) { UNUSED(); }/*
    UNUSED();

*/
// C flag not implemented!!!
void instruction_CPX_Immediate(CPU_t* cpu) { UNUSED(); }

// C flag not implemented!!!
void instruction_CPX_ZeroPage(CPU_t* cpu) { UNUSED(); }

void instruction_CPX_Absolute(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_CPY_Immediate(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
// C flag not implemented!!!
void instruction_CPY_ZeroPage(CPU_t* cpu) { UNUSED(); }

void instruction_CPY_Absolute(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();
...
// Increments / Decrements
void instruction_INC_ZeroPage(CPU_t* cpu) { UNUSED(); }

void instruction_INC_ZeroPageX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_INC_Absolute(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_INC_AbsoluteX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/

void instruction_INX(CPU_t* cpu) { UNUSED(); }/*
    cpu->X++;
...
*/
void instruction_INY(CPU_t* cpu) { UNUSED(); }/*
    cpu->Y++;
...
void instruction_DEC_ZeroPage(CPU_t* cpu) { UNUSED(); }

void instruction_DEC_ZeroPageX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_DEC_Absolute(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_DEC_AbsoluteX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/

void instruction_DEX(CPU_t* cpu) { UNUSED(); }
/*
    cpu->X--;
    ...
    CPU_tick(cpu, 2);
*/
void instruction_DEY(CPU_t* cpu) { UNUSED(); }
/*
    cpu->Y--;
...
// Shifts / Rotates
void instruction_ASL_Accumulator(CPU_t* cpu) { UNUSED(); }

void instruction_ASL_ZeroPage(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ASL_ZeroPageX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ASL_Absolute(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ASL_AbsoluteX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/

void instruction_LSR_Accumulator(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_LSR_ZeroPage(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_LSR_ZeroPageX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_LSR_Absolute(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_LSR_AbsoluteX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/

void instruction_ROL_Accumulator(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ROL_ZeroPage(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ROL_ZeroPageX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ROL_Absolute(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ROL_AbsoluteX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/

void instruction_ROR_Accumulator(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ROR_ZeroPage(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ROR_ZeroPageX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ROR_Absolute(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_ROR_AbsoluteX(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();
...
// Jumps / Calls
void instruction_JMP_Absolute(CPU_t* cpu) { UNUSED(); }
/*
    word addr = cpu->memory[cpu->PC++];
    addr += cpu->memory[cpu->PC++] << 8;
    cpu->PC = addr;
...
void instruction_JMP_Indirect(CPU_t* cpu) { UNUSED(); }

void instruction_JSR(CPU_t* cpu) { UNUSED(); }
/*
    word addr = cpu->memory[cpu->PC++];
    addr += cpu->memory[cpu->PC++] << 8;
...
// Branches
void instruction_BCC(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_BCS(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_BEQ(CPU_t* cpu) { UNUSED(); }

void instruction_BMI(CPU_t* cpu) { UNUSED(); }

void instruction_BNE(CPU_t* cpu) { UNUSED(); }

void instruction_BPL(CPU_t* cpu) { UNUSED(); }

void instruction_BVC(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();

*/
void instruction_BVS(CPU_t* cpu) { UNUSED(); }
/*
    UNUSED();
...
// Flags
void instruction_CLC(CPU_t* cpu) { UNUSED(); }
/*
    CPU_offFlag(cpu, 'c');
    CPU_tick(cpu, 2);

*/
void instruction_CLD(CPU_t* cpu) { UNUSED(); }
/*
    CPU_offFlag(cpu, 'd');
    CPU_tick(cpu, 2);

*/
void instruction_CLI(CPU_t* cpu) { UNUSED(); }
/*
    CPU_offFlag(cpu, 'i');
    CPU_tick(cpu, 2);

*/
void instruction_CLV(CPU_t* cpu) { UNUSED(); }
/*
    CPU_offFlag(cpu, 'v');
    CPU_tick(cpu, 2);

*/
void instruction_SEC(CPU_t* cpu) { UNUSED(); }
/*
    CPU_onFlag(cpu, 'c');
    CPU_tick(cpu, 2);

*/
void instruction_SED(CPU_t* cpu) { UNUSED(); }
/*
    CPU_onFlag(cpu, 'd');
    CPU_tick(cpu, 2);

*/
void instruction_SEI(CPU_t* cpu) { UNUSED(); }
/*
    CPU_onFlag(cpu, 'i');
    CPU_tick(cpu, 2);
...
// System
void instruction_BRK(CPU_t* cpu) { UNUSED(); }
/*
    word addr = 0;
    ...
    CPU_tick(cpu, 7);
*/
void instruction_NOP(CPU_t* cpu) { UNUSED(); }
/*
    CPU_tick(cpu, 2);
*/
